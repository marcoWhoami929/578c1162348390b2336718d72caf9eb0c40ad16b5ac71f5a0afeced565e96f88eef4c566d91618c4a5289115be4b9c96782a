                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Agente</label>
                                                                                <span class="filter-icon"><i class="fa fa-filter"></i></span>
                                                                                <select class="form-control selectorAgentes" id="agente" onchange="cargarVentasLitreadoMonto(1,'','');cargarVentasLitreadoUnidades(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Canal</label>
                                                                                <span class="filter-icon"><i class="fa fa-filter"></i></span>
                                                                                <select class="form-control" id="canal" onchange="cargarVentasLitreadoMonto(1,'','');cargarVentasLitreadoUnidades(1,'','');">
                                                                                    <option value=""></option>
