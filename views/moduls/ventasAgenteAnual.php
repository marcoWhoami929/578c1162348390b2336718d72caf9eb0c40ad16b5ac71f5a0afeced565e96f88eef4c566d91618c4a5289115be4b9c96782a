                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block table-border-style">
                                                            <div class="table-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Agente</label>
                                                                                <span class="filter-icon"><i class="fa fa-filter"></i></span>
                                                                                <select class="form-control selectorAgentes" id="agente" onchange="cargarVentasAgenteAnual(1);">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Canal</label>
                                                                                <span class="filter-icon"><i class="fa fa-filter"></i></span>
                                                                                <select class="form-control" id="canal" onchange="cargarVentasAgenteAnual(1);">
                                                                                    <option value=""></option>
                                                                ...
                                                                <div class="ventasAgenteAnualData">
