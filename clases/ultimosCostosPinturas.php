...
class ultimosCostosPinturas extends ConexionPinturas
{
    public $mysqli;
    public $counter;
    ...
    public function getData($tables, $campos, $search)
    {
        ...
        $año = $search['año'];
        $sWhere = " CCODIGOPRODUCTO LIKE '%" . $search['query'] . "%' and CIDDOCUMENTODE = '19' and CIDCLIENTEPROVEEDOR != 19";
    ...
    public function getDataReporteUltimosCostos($codigoProducto, $añoElegido)
    {
        ...
        $año = $añoElegido;
        $sWhere = " CCODIGOPRODUCTO LIKE '%" . $codigoProducto . "%' and CIDDOCUMENTODE = '19' and CIDCLIENTEPROVEEDOR != 19";
