...
if ($action == 'ventasCanal') {
    ...
    $search = array("query" => $query, "año" => $año, "estatus" => $estatus, "agente" => $agente, "semana" => $week, "per_page" => $per_page, "offset" => $offset);
...
?> <div class="fixedColumns">
            <table class="table table-responsive table-striped table-hover " id="tableVentasCanal">
                <thead>
                    <tr>
                        <th>CANAL</th>
